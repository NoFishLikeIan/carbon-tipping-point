...
\begin{frame} \frametitle{Economy... without climate change}
    \begin{columns}
        \column{0.3\linewidth}
        \begin{equation*}
            \frac{\d {{\color{cyan} y}}}{\d t} = \phi(t, 1 - \control{\chi}) \; - \; \delta_k
        \end{equation*}
        \column{0.6\linewidth}
        \begin{figure}[H]
            \centering
...
\begin{frame} \frametitle{Economy... with climate change}
    \begin{equation*}
        \frac{\d {{\color{cyan} y}}}{\d t} = \phi(t, 1 - \control{\chi}) - \delta_k - d({\color{red} T}) - \frac{\omega}{2} \left(1 - \frac{E(\control{\alpha})}{E^{\mathrm{B}}} \right)^2
    \end{equation*}
\end{frame}
