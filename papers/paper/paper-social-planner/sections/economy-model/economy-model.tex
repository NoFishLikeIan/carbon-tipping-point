...
As in \cite{pindyck_economic_2013} and \cite{hambel_optimal_2021}, I assume output $Y$ to be a linear function of capital $K$, \begin{equation}
Y =  A K,
...
As in \citeauthor{nordhaus_optimal_1992} (\citeyear{nordhaus_optimal_1992}), I assume abatement expenditures to be proportional to output $Y$ and quadratic in the emission reduction rate $\varepsilon$ (\ref{eq:emission-reduction-rate}), namely $B = \beta(\varepsilon) Y $ where \begin{equation} \label{eq:abatement-costs}
