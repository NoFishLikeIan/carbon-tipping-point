...
# ╔═╡ e9fe9f64-e81b-4dd9-903d-c58c3810c4bb
md"""
Temperature deviation from the baseline $T_0 = 2$,  change as $\dot{T} = g(T + T_0, e)$, where
"""

# ╔═╡ 163b87df-71ee-4c1b-a926-a9141d480a67
g(T, e) = T^3 - T + e;

# ╔═╡ 14bfb003-6d5d-4fd1-b970-0eeeb50f9963
let
	find_zeros(T -> g(T, 1), (-5, 5))
end
