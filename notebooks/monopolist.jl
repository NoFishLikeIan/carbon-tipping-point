...
begin
	...
	highregime = range(1. + 1e-3, 2.2; length = N)
...
# ╔═╡ 88e94adb-ea29-46b2-81e5-32c0539e7d16
monopolist(τ, γ) = op.OptimalPollution(τ = τ, γ = γ);

# ╔═╡ 2269a457-0182-4419-8e5c-d3969d55566d
md"""
- Carbon tax $\tau$ $(@bind τ Slider(0.01:0.01:1, show_value = true, default = 0.5))
- Climate damage $\gamma$ $(@bind γ Slider(0:0.01:3, show_value = true, default = 2.))
"""

# ╔═╡ 6d6a7293-1933-4b49-8cc4-5ccc8889119b
# ╠═╡ show_logs = false
begin
	m = op.OptimalPollution(τ = τ, γ = γ, σ² = 5)
...
let
	vfig = plot(xlabel = "Temperature, \$x\$", ylabel = "Emissions, \$e\$", ylims = (0, 2), legend = :topright, title = "System with \$\\tau = $τ\$ and \$\\gamma = $γ\$")
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "052cf7d78f30efccdd795d864459f205166179ec"
...
git-tree-sha1 = "cdfa571e8e6f3ab0bfa8fb5ae01fa04439bff77d"
...
git-tree-sha1 = "a837855895d10558f2907a1006e69ba3e52d7bd9"
